...
def login():
    ...
    form = LoginForm()
    variables = {"title": "Keep me on rails - Login", "form": form}
...
def signup():
    """Signup form page."""
    form = SignupForm()
    variables = {"title": "Keep me on rails - Signup", "form": form}
    if form.validate_on_submit():
        user_interface = UserInterface(
            email=form.email.data, username=form.name.data, password=form.password.data
        )
